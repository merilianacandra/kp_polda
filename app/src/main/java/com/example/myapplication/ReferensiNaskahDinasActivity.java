...
public class ReferensiNaskahDinasActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_referensi_naskah_dinas);
                        ...
                        try {
                            ...
                            if(obj.optString("status").equals("true")){
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    DataJenisNaskahDinas playerModel = new DataJenisNaskahDinas();
                                    JSONObject dataobj = dataArray.getJSONObject(i);
                                    playerModel.setId_jenis_naskah_dinas(dataobj.getString("id_jenis_naskah_dinas"));
...
//                                    playerModel.setImage(dataobj.getString("foto_bengkel"));
    ...
    private void setupRecycler(){
        ...
        rvAdapter = new JenisNaskahDinasAdapter(this,dataModelArrayList);
