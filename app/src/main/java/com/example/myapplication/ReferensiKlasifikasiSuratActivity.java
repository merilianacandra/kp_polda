...
public class ReferensiKlasifikasiSuratActivity extends AppCompatActivity {
    ...
    private String URLstring = Server.URL + "select_klasifikasi_surat.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_referensi_klasifikasi_surat);
                        ...
                        try {
                            ...
                            if(obj.optString("status").equals("true")){
                                ...
                                for (int i = 0; i < dataArray.length(); i++) {
                                    ...
                                    DataKlasifikasiSurat playerModel = new DataKlasifikasiSurat();
                                    JSONObject dataobj = dataArray.getJSONObject(i);
                                    playerModel.setId_klasifikasi_surat(dataobj.getString("id_klasifikasi_surat"));
                                    playerModel.setKlasifikasi_surat(dataobj.getString("klasifikasi_surat"));
                                    playerModel.setKode_klasifikasi_surat(dataobj.getString("kode_klasifikasi_surat"));
...
//                                    playerModel.setImage(dataobj.getString("foto_bengkel"));
    ...
    private void setupRecycler(){
        ...
        rvAdapter = new KlasifikasiSuratAdapter(this,dataModelArrayList);
