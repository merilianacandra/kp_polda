...
import com.example.myapplication.DetailSuratKeluarActivity;
...
public class SuratKeluarAdapter extends RecyclerView.Adapter<SuratKeluarAdapter.MyViewHolder> {

    List<DataSurat> my_list;
    List<DataSurat> my_listfull;
    Context context;

    public SuratKeluarAdapter(Context context, List<DataSurat> my_list) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.mCardViewSurat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context, DetailSuratKeluarActivity.class);
