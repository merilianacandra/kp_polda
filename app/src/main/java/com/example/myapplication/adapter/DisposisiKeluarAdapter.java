...
import com.example.myapplication.DetailDisposisiKeluarActivity;
...
public class DisposisiKeluarAdapter extends RecyclerView.Adapter<DisposisiKeluarAdapter.MyViewHolder> {

    List<DataDisposisi> my_list;
    List<DataDisposisi> my_listfull;
    Context context;

    public DisposisiKeluarAdapter(Context context, List<DataDisposisi> my_list) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.mCardViewDisposisi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context, DetailDisposisiKeluarActivity.class);
